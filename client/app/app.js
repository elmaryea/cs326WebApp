...
class ContractPage extends React.Component {
  render() {
    return <Contract user="000000000000000000000001" contractId = {this.props.params.id}/>;
  }
}
...
class ContractFormPage extends React.Component {
  ...
  class PrivateProfilePage extends React.Component {
    render() {
      return <PrivateProfile user="000000000000000000000001"/>;
    }
}
class PublicProfilePage extends React.Component {
  render() {
    return <PublicProfile user="000000000000000000000001" pageUser = {this.props.params.id}/>;
  }
}
...
ReactDOM.render((
  <Router history={hashHistory}>
    <Route path="/" component={App}>
      ...
      <Route path="publicprofile/:id" component={PublicProfilePage} />
